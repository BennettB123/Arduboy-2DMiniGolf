...
constexpr uint16_t FX_DATA_PAGE  = 0xffde;
constexpr uint24_t FX_DATA_BYTES = 8512;
...
constexpr uint8_t  InstructionsSpriteFrames = 4;

constexpr uint24_t Maps = 0x001AC8;
